...
create table ros.product_dimension
...
create table ros.promotion_dimension
...
create table ros.date_dimension
...
create table ros.vendor_dimension
...
create table ros.employee_dimension
...
create table ros.shipping_dimension
...
create table ros.warehouse_dimension
...
create table ros.inventory_fact
...
alter table ros.inventory_fact 
        ...
        add constraint fk_inventory_product foreign key (product_key,product_version) 
            references ros.product_dimension (product_key,product_version),
        add constraint fk_inventory_warehouse foreign key (warehouse_key) 
            references ros.warehouse_dimension (warehouse_key);

create table ros.store_dimension
...
alter table ros.store_sales_fact
        ...
        add constraint fk_store_sales_store foreign key (store_key) 
            references ros.store_dimension (store_key),
        add constraint fk_store_sales_promotion foreign key (promotion_key) 
            references ros.promotion_dimension (promotion_key),
        add constraint fk_store_sales_customer foreign key (customer_key) 
            references ros.customer_dimension (customer_key),
        add constraint fk_store_sales_employee foreign key (employee_key) 
            references ros.employee_dimension (employee_key);

create table ros.store_orders_fact
(    product_key             integer         not null,
    product_version         integer         not null,
    store_key               integer         not null,
...
alter table ros.store_orders_fact
        ...
        add constraint fk_store_orders_vendor foreign key (vendor_key) 
            references ros.vendor_dimension (vendor_key),
        add constraint fk_store_orders_employee foreign key (employee_key) 
            references ros.employee_dimension (employee_key);

create table ros.online_page_dimension
...
create table ros.call_center_dimension
...
alter table ros.Online_Sales_Fact
    add constraint fk_saledate foreign key (sale_date_key) 
        ...
        add constraint fk_shipdate foreign key (ship_date_key) 
            references ros.date_dimension (date_key),
        add constraint fk_product foreign key (product_key,product_version) 
            references ros.product_dimension (product_key,product_version),
        add constraint fk_customer foreign key (customer_key) 
            references ros.customer_dimension (customer_key),
        add constraint fk_cc foreign key (call_center_key) 
            references ros.call_center_dimension (call_center_key),
        add constraint fk_op foreign key (online_page_key) 
            references ros.online_page_dimension (online_page_key),
        add constraint fk_shipping foreign key (shipping_key) 
            references ros.shipping_dimension (shipping_key),
        add constraint fk_warehouse foreign key (warehouse_key) 
            references ros.warehouse_dimension (warehouse_key),
        add constraint fk_promotion foreign key (promotion_key) 
            references ros.promotion_dimension (promotion_key);
